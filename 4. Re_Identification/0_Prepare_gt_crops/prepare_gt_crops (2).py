...
if __name__ == "__main__":
    ...
    print("\nSkipping Validation set preparation as requested.")
     prepare_split_data(
    ...
    prepare_split_data(
        ...
        output_crop_dir=OUTPUT_TEST_CROP_DIR,
    ...
    print(f"Check output folder for the new test set:\n  Test: {OUTPUT_TEST_CROP_DIR}")
